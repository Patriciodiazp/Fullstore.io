//Ver que zapatillas hay en stock
const stock = ['Nike90','Nike97','Adidas Ultraboost','Adidas Superstar']

console.log(stock.includes('Nike97'))
console.log(stock.includes('Adidas Ultraboost'))
console.log(stock.includes('Nike90'))
console.log(stock.includes('AirJordan1'))
